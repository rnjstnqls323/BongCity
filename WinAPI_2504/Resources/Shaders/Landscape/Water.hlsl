...
float4 PS(PixelInput input) : SV_TARGET
{
    ...
    float4 normal = refractionNormalMap.Sample(samplerState, input.uv) * 2.0f - 1.0f;
    ...
    float4 reflectionColor = reflectionMap.Sample(samplerState, uv);
    ...
    float4 refractionColor = refractionMap.Sample(samplerState, uv);
